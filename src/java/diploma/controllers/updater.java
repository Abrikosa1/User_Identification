...
public class updater {
    public static void updateRec(){
        ...
        faceRecognizer.save("C:\\Users\\Пользователь\\Documents\\NetBeansProjects\\Diploma\\result_train.xml");
        for (File myFile : new File("C:\\trainingImages2").listFiles())
                if (myFile.isFile()) myFile.delete();
        long timeSpent = System.currentTimeMillis() - startTime;
        System.out.println("программа updater выполнялась " + timeSpent + " миллисекунд");
    }
